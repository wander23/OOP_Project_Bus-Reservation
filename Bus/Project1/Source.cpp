...
private:
    ...
    //xai 1 lan, sau co them class BusStation m se hieu hon
    string _name;
    string _tel;

    // xai nhieu lan, khi nhap bat khach nhap ten voi sdt, neu trung voi cai co san thi them vao cai co san
    int weightOfGoods;
    int totalMoneySpent;
